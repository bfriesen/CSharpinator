            ...
            get
            {
                return _classes.GetOrAdd(
                    ...
                    typeName => new BclClass(
                        ...
                        value => value is int || value is uint || value is short || value is ushort || value is byte || value is sbyte));
            }
        }
            ...
            get
            {
                return _classes.GetOrAdd(
                    ...
                    typeName => new NullableBclClass(
                        ...
                        value => value == null || value is int || value is uint || value is short || value is ushort || value is byte || value is sbyte,
                        ".ToString()",
                        "int.Parse(value)"));
            }
        }
            ...
            get
            {
                return _classes.GetOrAdd(
                    ...
                    typeName => new BclClass(
                        ...
                        value => value is long || value is ulong || value is int || value is uint || value is short || value is ushort || value is byte || value is sbyte));
            }
        }
            ...
            get
            {
                return _classes.GetOrAdd(
                    ...
                    typeName => new NullableBclClass(
                        ...
                        value => value == null || value is long || value is ulong || value is int || value is uint || value is short || value is ushort || value is byte || value is sbyte,
                        ".ToString()",
                        "long.Parse(value)"));
            }
        }
